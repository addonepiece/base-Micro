...
public abstract class ProjectException extends RuntimeException implements Serializable {

    private static final long serialVersionUID = -8957643959299095415L;
     ...
     * 初始化函数
     */
    public ProjectException( String errCode, String message, Throwable cause )
    {
        super( message, cause );
     ...
     * 初始化函数
     */
    public ProjectException( String errCode, String message )
    {
        super( message );
        this.errCode = errCode;
    }
