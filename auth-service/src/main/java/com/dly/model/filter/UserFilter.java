...
public class UserFilter {
    ...
    public String toString() {
        return "UserFilter [uuid=" + uuid + ", account=" + account + ", userName=" + userName + ", password=" + password
                + ", encryption=" + encryption + ", phone=" + phone + ", email=" + email + ", term=" + term
                + ", status=" + status + ", lastLoginIp=" + lastLoginIp + ", lastLoginTime=" + lastLoginTime
                + ", operator=" + operator + ", createTime=" + createTime + ", remarks=" + remarks + "]";
    }
